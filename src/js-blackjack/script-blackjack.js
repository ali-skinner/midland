...
// break up the dealer/player hand arrays to build #'s only array? or is this irrelevant bc the cards are setup as objects and can use card.value or is that only good in the buildDeck funct?
let fullDeck = [];
...
function drawCard(deck) {
    if (deck.length > 0) {
        ...
        const randomCard = deck.splice(randomDraw, 1);
        return randomCard;
